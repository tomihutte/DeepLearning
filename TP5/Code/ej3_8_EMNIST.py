...
plt.tight_layout()
plt.savefig("EJ3_letters_mnist_acc.pdf")
plt.show()
...
plt.legend(fontsize=fs)
plt.tight_layout()
plt.savefig("EJ3_letters_mnist_loss.pdf")
plt.show()
...
plt.legend(fontsize=fs)
plt.tight_layout()
plt.savefig("EJ3_mnist_noTL_acc.pdf")
plt.show()
...
plt.legend(fontsize=fs)
plt.tight_layout()
plt.savefig("EJ3_mnist_noTL_loss.pdf")
plt.show()
